...
var Toolkits, _, __IFRAME_REGISTER_FUNCTION__, board_boot, iframe_push;
...
window.iframe_switch = function(maintitle, subtitle, d) {
  var main_board, main_node, sub_node;
  if (!board_boot) {
    board_boot = true;
